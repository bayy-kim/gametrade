    ...
    <div className="flex min-h-screen">
      <aside className="w-64 bg-gray-950 p-6 border-r border-gray-800">
        ...
        <nav className="flex flex-col gap-2">
          <Link href="/admin/users/search" className="flex items-center gap-2 p-2 hover:bg-gray-800 rounded-lg text-gray-300 hover:text-white">
  <Search className="w-5 h-5" /> Cari Pengguna
</Link>
